...
public class MarkerManager {
	...
	public Marker addMarker(String name, String groupName, int x, int y, int z, int dimension, int colour) {
		name = name.replace(":", "");
		groupName = groupName.replace(":", "");
		Marker m = new Marker(name, groupName, x, y, z, dimension, colour);
		this.addMarker(m);
		return m;
	}
