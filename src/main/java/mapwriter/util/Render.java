...
public class Render {
    ...
    public static void drawCircle(double x, double y, double r) {
        ...
        // ascending
        final double end = Math.PI * 2.0;
        final double incr = end / Render.circleSteps;
    ...
    public static int multiplyColours(int c1, int c2) {
        ...
        final float c1B = c1 >> 0 & 0xff;
        final float c2A = c2 >> 24 & 0xff;
    ...
    /*
     * public static void setCircularStencil(double x, double y, double r) {
     * GL11.glEnable(GL11.GL_STENCIL_TEST); // disable drawing to the color and depth buffers.
     * // circle will only be drawn to stencil buffer. GL11.glColorMask(false, false, false,
     * false); GL11.glDepthMask(false); // set up stencil func and op so that a 1 is always
     * written to the stencil buffer // whenever a pixel is drawn.
     * GL11.glStencilFunc(GL11.GL_NEVER, 1, 0x01); // replace stencil buffer value with 1
     * whenever stencil test fails. // keep stencil buffer value otherwise.
     ...
     * GL11.glStencilFunc(GL11.GL_EQUAL, 1, 0x01); } public static void disableStencil() {
